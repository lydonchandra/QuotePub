...
public class OnMessage extends NotificationBroadcasterSupport implements OnMessageMBean {
	...
	public OnMessage(String name) throws MalformedObjectNameException, InstanceAlreadyExistsException,
			MBeanRegistrationException, NotCompliantMBeanException {
		MBeanServer server = ManagementFactory.getPlatformMBeanServer();
		this.name = "com.don.trade.mq:type=OnMessage,name=" + name;
	...
	public synchronized long endCall( long startNano ) {
		...
		Notification notification = new Notification( name, objName, this.totalCalls, 
				this.lastCallTime, String.valueOf(this.lastCallNano));
